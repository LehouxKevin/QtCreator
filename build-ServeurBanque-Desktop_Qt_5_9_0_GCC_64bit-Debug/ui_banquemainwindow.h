...
public:
    ...
    void setupUi(QMainWindow *BanqueMainWindow)
    {
        ...
        pushButton->setGeometry(QRect(160, 200, 80, 25));
    ...
    {
        BanqueMainWindow->setWindowTitle(QApplication::translate("BanqueMainWindow", "BanqueMainWindow", Q_NULLPTR));
        pushButton->setText(QApplication::translate("BanqueMainWindow", "Quitter", Q_NULLPTR));
    } // retranslateUi
