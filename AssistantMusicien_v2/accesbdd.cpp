...
void AccesBdd::enregistrerModificationTitre(Titre *titre)
{
    ...
    requete.prepare("update Titre set cheminAudio = :cheminAudio,cheminPartition = :cheminPartition,cheminEnregistrement = :cheminEnregistrement, cheminRythme = :cheminRythme,tonalite = :tonalite , tempo = :tempo , dureeTitre = :dureeTitre , note = :note where (nomTitre = :nomTitre and interprete = :interprete);");
    requete.bindValue(":tonalite",titre->ObtenirTonalite());
    requete.bindValue(":tempo", titre->ObtenirTempo());
    requete.bindValue(":dureeTitre",titre->ObtenirDuree());
    requete.bindValue(":note",titre->ObtenirNote());
