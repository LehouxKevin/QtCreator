...
public:
    ...
    void setupUi(QWidget *LecteurAudio)
    {
        ...
        QIcon icon16;
        icon16.addFile(QStringLiteral(":/images/repeter.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButtonRepeter->setIcon(icon16);
        ...
        QIcon icon17;
        icon17.addFile(QStringLiteral(":/images/iconeAleatoireBleue.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButtonAleatoire->setIcon(icon17);
